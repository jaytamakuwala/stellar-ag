...
export const getSummaryDataMain = async (summaryDataPayload) => {
    const summaryDataMainPostFix = import.meta.env.VITE_SUMMARY_DATA_MAIN_POST_FIX;
...
export const getChartBarData = async (payload) => {
    const getChartBarDataPostFix = import.meta.env.VITE_GET_CHART_BAR_DATA_POST_FIX;
...
export const getChartPieData = async (payload) => {
    const getChartPieDataPostFix = import.meta.env.VITE_GET_CHART_PIE_DATA_POST_FIX;
    const url = `${STELLAR_BASE_URL}${getChartPieDataPostFix}`;
    return await getRequest(url, payload);
};

export const getChartBubbleData = async (payload) => {
    const getChartBubbleDataPostFix = import.meta.env.VITE_GET_CHART_BUBBLE_DATA_POST_FIX;
    const url = `${STELLAR_BASE_URL}${getChartBubbleDataPostFix}`;
    return await getRequest(url, payload);
};

export const getChartBubbleExpiryData = async (payload) => {
    const getChartBubbleExpiryDataPostFix = import.meta.env.VITE_GET_CHART_BUBBLE_EXPIRY_DATA_POST_FIX;
